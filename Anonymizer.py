...
if len(sys.argv) < 2:
    print(
        "Structure: python3 Anonymizer.py [server] [database_name] [user] [pwd]")
    ...
    while table_name != '0':
        ...
        for col in df:
            ...
            # add more st_addresses to make it more accurate
            st_addresses = [" rd", " st", " ln",
                            " way", "alley", "ave", "court"]
        ...
        df.to_sql('' + table_name + "_Anonymized", con=engine,
